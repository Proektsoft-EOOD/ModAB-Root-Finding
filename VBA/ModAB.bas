...
' ============================================================
' find_root — Modified Anderson–Björck root finder (UDF)
...
Public Function find_root(x_cell As Range, y_cell As Range, _
    ...
    Dim y1 As Double, y2 As Double, y3 As Double, f1 As Double, f2 As Double
    ...
    For i = 1 To maxiter
        ...
        If (x2 - x1) <= epsx Then find_root = IIf(bisection, x3, ClampD(x3, x1, x2)): Exit Function
...
Private Function ClampD(ByVal c As Double, ByVal a As Double, ByVal b As Double)
    If c < a Then
        ClampD = a
    ElseIf c > b Then
        ClampD = b
